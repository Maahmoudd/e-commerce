...
class BrandsController extends Controller
{
    ...
    {
        $this->categoryService->create($request->validated(), Brand::class, 'logo', 'uploads/brands');
    ...
    {
        $this->categoryService->update($request->validated(), $id, Brand::class, 'logo', 'uploads/brands');
